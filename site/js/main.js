...
// console.log('savedTheme: '+localStorage.getItem('saved-theme'));
// console.log('savedIcon: '+localStorage.getItem('saved-icon'));
...
// console.log('theem: '+savedTheme, 'icon: '+savedIcon);
...
window.addEventListener('scroll', () => {
    ...
    sections.forEach(current => {
        ...
        // console.log(id, ' - h: '+sectionHeight, ' - top: '+sectionTop);
        ...
        // console.log('scrollY: '+scrollY, 'sectionHeight: '+sectionHeight, 'sectionTop: '+sectionTop, id, 'soma: '+sectionHeight+sectionTop );
    });
});
